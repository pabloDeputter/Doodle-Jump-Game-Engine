...
\begin{figure}[!tbp]
  \centering
  \subfloat[Main menu.]{\includegraphics[width=0.4\textwidth]{menuMain1.png}\label{fig:f1}}
  \hfill
  \subfloat[Play state.]{\includegraphics[width=0.4\textwidth]{playPurple.png}\label{fig:f2}}
\end{figure}
...
\begin{figure}[!tbp]
  \centering
  \subfloat[Settings state.]{\includegraphics[width=0.4\textwidth]{menuSettings.png}\label{fig:f1}}
  \hfill
  \subfloat[Shop menu.]{\includegraphics[width=0.4\textwidth]{menuShop}\label{fig:f2}}
\end{figure}
